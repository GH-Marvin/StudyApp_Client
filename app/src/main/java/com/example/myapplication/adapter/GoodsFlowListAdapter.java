...
public class GoodsFlowListAdapter extends RecyclerView.Adapter<GoodsFlowListAdapter.InnerHolder> {
    ...
    @NonNull
    @Override
    public GoodsFlowListAdapter.InnerHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        mParent = parent;
        //找到View
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_goods_flow, parent, false);
        return new InnerHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull GoodsFlowListAdapter.InnerHolder holder, final int position) {
        //封装数据
        ...
        holder.goodsName_tv.setTextSize(15);
